...
loss = gfc.select("loss")                     # 1 = tree cover lost 2001-2023
loss_year = gfc.select("lossyear")              # 1-23 (21 = 2021)
...
# Loss occurring from 2021 onwards within baseline forest
recent_loss = loss.eq(1).And(loss_year.gte(21)).And(forest_2000).rename("recent_loss").toFloat()
...
print("Downloading forest loss grid from Earth Engine...")
